...
This project is a browser-based Etch-A-Sketch game built with HTML, CSS,, and JavaScript.
...
2. Click the "Choose your grid size!" button.
3. Enter a number between 50 and 100 for the size of the grid.
4. Hover your mouse over the squares to draw patterns.

## What I learned

- Dynamic DOM manipulation.
- Event handling.
- CSS Grid for dynamic layout of squares.
- Combining JavaScript and CSS transitions for smooth visual effects.
